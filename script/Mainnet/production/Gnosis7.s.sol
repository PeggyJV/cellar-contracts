...
/**
 * @dev Run
 *      `source .env && forge script script/Mainnet/production/Gnosis7.s.sol:Gnosis7Script --rpc-url $MAINNET_RPC_URL --sender $MULTI_SIG --with-gas-price 25000000000`
 */
contract Gnosis7Script is Script, MainnetAddresses {
