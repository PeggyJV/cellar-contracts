...
/**
 * @dev Run
 *      `source .env && forge script script/BinanceSmartChain/test/DeployAxelarProxy.s.sol:DeployAxelarProxyScript --evm-version london --rpc-url $BNB_RPC_URL  --private-key $PRIVATE_KEY —optimize —optimizer-runs 200 --with-gas-price 100000000 --verify --etherscan-api-key $BSCSCAN_KEY --slow --broadcast`
