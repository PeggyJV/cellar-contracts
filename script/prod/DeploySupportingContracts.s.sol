...
/**
 * @dev Run
 *      `source .env && forge script script/prod/Deployer.s.sol:DeployerScript --rpc-url $MAINNET_RPC_URL  --private-key $DEPLOYER_DEPLOYER_KEY —optimize —optimizer-runs 200 --with-gas-price 25000000000 --verify --etherscan-api-key $ETHERSCAN_KEY --slow --broadcast`
