...
contract ContractDeploymentNames {
    // Infrastructure
    string public registryName = "PJV Registry V0.0";
    string public priceRouterName = "PJV PriceRouter V0.1";
    string public timelockOwnerName = "PJV Timelock Owner V0.0";
    string public protocolFeeCollectorName = "PJV Protocol Fee Collector V0.0";
    string public feesAndReservesName = "PJV Fees And Reserves V0.0";
    string public withdrawQueueName = "PJV Withdraw Queue V0.0";
    string public simpleSolverName = "PJV Simple Solver V0.0";
    string public atomicQueueName = "PJV Atomic Queue V0.0";
    string public incentiveDistributorName = "PJV Incentive Distributor V0.1";
    // Adaptors
    string public erc20AdaptorName = "PJV ERC20 Adaptor V0.0";
    string public erc4626AdaptorName = "PJV ERC4626 Adaptor V0.0";
    string public oneInchAdaptorName = "PJV 1Inch Adaptor V0.0";
    string public zeroXAdaptorName = "PJV 0x Adaptor V0.0";
    string public uniswapV3AdaptorName = "PJV Uniswap V3 Adaptor V0.0";
    string public uniswapV3PositionTrackerName = "PJV Uniswap V3 Position Tracker V0.0";
    string public swapWithUniswapAdaptorName = "PJV Swap With Uniswap Adaptor V0.0";
    string public aaveV3ATokenAdaptorName = "PJV Aave V3 AToken Adaptor V0.0";
    string public aaveV3DebtTokenAdaptorName = "PJV Aave V3 Debt Token Adaptor V0.0";
    string public compoundV3SupplyAdaptorName = "PJV Compound V3 Supply Adaptor V 0.0";
    string public compoundV3RewardsAdaptorName = "PJV Compound V3 Rewards Adaptor V 0.0";
    string public feesAndReservesAdaptorName = "PJV Fees And Reserves Adaptor V 0.0";
    string public balancerPoolAdaptorName = "PJV Balancer Pool Adaptor V 0.0";
    // Deploy below only after it has been confirmed that they will work on L2
    string public balancerV2PoolAdaptorName = "PJV Balancer Pool Adaptor V 0.0";
    string public auraAdaptorName = "PJV Aura ERC4626 Adaptor V 0.0";
    string public curveAdaptorName = "PJV Curve Adaptor V 0.0";
