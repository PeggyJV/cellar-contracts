...
contract SwapRouterTest is Test {
    ...
    function testCurveSwap(uint256 assets) external {
        ...
        bytes memory swapData = abi.encode(route, swapParams, DAI, assets, 0);
    ...
    function testBalancerSwap(uint256 assets) external {
        ...
        bytes memory swapData = abi.encode(0xC697051d1C6296C24aE3bceF39acA743861D9A81, AAVE, WETH, assets, 0);
        uint256 out = swapRouter.swap(SwapRouter.Exchange.BALANCERV2, swapData, receiver);
