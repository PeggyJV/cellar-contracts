...
contract MorphoBlueCollateralAndDebtTest is MainnetStarterTest, AdaptorHelperFunctions {
    ...
    uint32 public morphoBlueCollateralWETHPosition = 1_000_001;
    uint32 public morphoBlueDebtWETHPosition = 1_000_002;
    uint32 public morphoBlueCollateralUSDCPosition = 1_000_003;
    uint32 public morphoBlueDebtUSDCPosition = 1_000_004;
    uint32 public morphoBlueWBTCCollateralPosition = 1_000_005;
    uint32 public morphoBlueWBTCDebtPosition = 1_000_006;
    ...
    address private _morphoBlue; // TODO - get deployment contracts for MorphoBlue, or deploy our own as a test within our setup. USE THE CELLAR CREATION CODE SEQUENCE?
    ...
    function setUp() public {
        ...
        cellar.addPosition(3, morphoBlueCollateralWETHPosition, abi.encode(0), false);
