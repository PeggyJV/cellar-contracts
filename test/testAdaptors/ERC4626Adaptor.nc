...
// @notice this is a duplicate of CellarAdaptor.t.sol that tests with CellarAdaptor but runs with ERC4626Adaptor instead.
// TODO: delete this file if CellarWithERC4626Adaptor.t.sol captures the test intent of this file too properly.
contract ERC4626AdaptorTest is MainnetStarterTest, AdaptorHelperFunctions {
  ...
  function testUsingIlliquidCellarPosition() external {
    ...
    assertEq(liquidAssets, initialAssets, "Meta Cellar only liquid assets should be USDC deposited in constructor.");
