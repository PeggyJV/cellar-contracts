...
contract CellarVestingTest is Test {
    ...
    // test user withdrawal from vesting
    // test strategist withdrawal from vesting deposit
    // test strategist withdrawal from any vesting deposit
    // test strategist withdrawAll
