...
import { ICellarV15, WithdrawType } from "src/interfaces/ICellarV15.sol";
...
contract DeployedCellarTest is Test {
    ...
    function _testCellar(Cellar cellar) internal {
        ...
        ICellarV15(address(cellar)).rebalance(address(USDC), address(WBTC), amount, SwapRouter.Exchange.UNIV3, params);
        vm.stopPrank();
        ...
        ICellarV15(address(cellar)).rebalance(
            address(USDC),
            address(WBTC),
            assets,
