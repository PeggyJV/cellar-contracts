...
contract EulerETokenAdaptor is BaseAdaptor, EulerBaseAdaptor {
     ...
     */
    function withdrawFromEuler(IEulerEToken tokenToWithdraw, uint256 subAccountId, uint256 amountToWithdraw) public {
     ...
     */
    function transferETokensBetweenSubAccounts(IEulerEToken eToken, uint256 from, uint256 to, uint256 amount) public {
