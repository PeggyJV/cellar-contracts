...
interface IMorpho {
    ...
    // TODO: uncommented this so we could use the getter, but perhaps we aren't supposed use the struct.
    ...
    /// FUNCTIONS NOT PART OF STANDARD IMORPHO.sol

    /// TODO: not sure if I should use the interface function like this to access the getter, or use the provided interface function to access each individual returned param.
